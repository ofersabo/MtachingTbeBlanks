...

{
  ...
  "train_data_path":  if first_step then "data/train_easy.json" else "data/merged_easy_and_hard.json",
  "validation_data_path": if first_step then "data/train_hard.json" else "data/val_5K.json",
  "model": {
    "type": "bert_for_mtb",
